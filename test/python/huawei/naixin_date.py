...
# 输出 “5”
start_time = "2014 04 05 6|"
import time
localtime = time.strftime("%Y %m %d",time.localtime())
localtime2 = time.strftime("%Y %b %d %a",time.localtime())
data_input = start_time + localtime
# print start_time + localtime
...
print "Start: 2014 Apr 05 Sat"
print "Now:  ",localtime2
print "derta days:",derta
